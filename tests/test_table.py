...
def _render_table_widths(console: Console, table: Table) -> None:
...
def _render_table_styles(console: Console, table: Table) -> None:
...
def _render_table_sizing(console: Console, table: Table) -> None:
    table.padding = 1
    console.print(table)
    table.width = 20
...
def render_tables():
    ...
    _render_table_widths(console, table)
    assert table.row_count == 1
    _render_table_styles(console, table)
    _render_table_sizing(console, table)
